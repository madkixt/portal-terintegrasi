...
class CUserAssignButtonColumn extends CButtonColumn
{
	/**
	 * @var array the HTML options for the data cell tags.
	 */
	public $htmlOptions=array('class'=>'assign-button-column');
	/**
	 * @var array the HTML options for the header cell tag.
	 */
	public $headerHtmlOptions=array('class'=>'assign-button-column');
	/**
	 * @var array the HTML options for the footer cell tag.
	 */
	public $footerHtmlOptions=array('class'=>'assign-button-column');
	/**
	 ...
	 */
	public $template='{view} {update} {delete} {unassign}';
	/**
